package proven.friends.filters;
...
import proven.friends.servlets.FriendRequestResult;
    ...
    **/
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (accessGranted(req)) {
            ...
            FriendRequestResult result = new FriendRequestResult("User no authenticated", 0);
